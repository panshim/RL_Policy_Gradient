...
# It is an implementation of Actor-Critic algorithm. The only modifications
# we made, compared with the reference codes, are processing the samples by computing
# the one-step TD target as returns.
