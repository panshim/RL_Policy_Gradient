...
# https://github.com/aravindr93/mjrl/blob/master/mjrl/utils/train_agent.py
# The only modification is that we made the evaluation of policy to be
...
from mjrl.samplers.core import sample_paths, sample_paths_lstm
import numpy as np
import pickle
...
def train_agent(job_name, agent,
    ...
    for i in range(i_start, niter):
        ...
        if evaluation_rollouts is not None and evaluation_rollouts > 0:
            ...
            if lstm:
                # print("HERE")
                eval_paths = sample_paths_lstm(num_traj=evaluation_rollouts, policy=agent.policy, num_cpu=num_cpu,
